...
static struct req_format *req_formats[] = {
	...
	&RQF_OUT_UPDATE,
        ...
        &RQF_OST_DESTROY,
        &RQF_OST_BRW_READ,
        &RQF_OST_COMP_BRW_READ, //IPCC
        &RQF_OST_BRW_WRITE,
        &RQF_OST_COMP_BRW_WRITE, //IPCC
        &RQF_OST_STATFS,
...
/*IPCC */
struct req_msg_field RMF_CHUNK_DESC =
        DEFINE_MSGF("chunk_desc", RMF_F_STRUCT_ARRAY,
                    sizeof(struct chunk_desc), lustre_swab_chunk_desc,
                    dump_cdesc);
EXPORT_SYMBOL(RMF_CHUNK_DESC);
...
struct req_format RQF_OST_COMP_BRW_READ =
        DEFINE_REQ_FMT0("OST_COMP_BRW_READ", ost_comp_brw_client, ost_brw_read_server);
...
struct req_format RQF_OST_COMP_BRW_WRITE =
        DEFINE_REQ_FMT0("OST_COMP_BRW_WRITE", ost_comp_brw_client, ost_brw_write_server);
