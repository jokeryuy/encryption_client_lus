...
# --enable-compression
#
# Check whether we should enable compression
#
AC_DEFUN([LC_CONFIG_COMPRESSION], [
AC_MSG_CHECKING([whether to enable compression])
AC_ARG_ENABLE([compression],
	AC_HELP_STRING([--enable-compression], [enable compression]),
...
lustre/utils/compression/Makefile
lustre/utils/compression/autoMakefile
lustre/utils/compression/lz4/Makefile
lustre/utils/compression/lz4/autoMakefile
lustre/osp/Makefile
