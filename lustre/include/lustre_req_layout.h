...
extern struct req_format RQF_OST_COMP_BRW_READ; //IPCC
extern struct req_format RQF_OST_BRW_WRITE;
extern struct req_format RQF_OST_COMP_BRW_WRITE; //IPCC
...
extern struct req_msg_field RMF_CHUNK_DESC; //IPCC
