...
struct osc_brw_async_args {
	...
	int			 aa_nio_count;
	u32			 aa_page_count;
	u32			 aa_c_page_count;	/* number of compressed pages */
	int			 aa_resends;
	char**		 aa_cmp_chunks;		/* pointerarray for releasing buffers loaned from cmp_pool */
	struct brw_page		**aa_ppga;
	struct brw_page		**aa_cppga;	/* pointer to array of compressed brw pages */
